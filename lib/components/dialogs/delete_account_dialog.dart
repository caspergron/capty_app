...
Future<void> deleteAccountDialog({Function()? onDelete}) async {
  final context = navigatorKey.currentState!.context;
  // sl<AppAnalytics>().screenView('delete-account-popup');
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            '${'delete_account_description'.recast}!',
