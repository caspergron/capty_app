  ...
  Widget _screenView(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text('${'exit_capty'.recast}?', textAlign: TextAlign.center, style: TextStyles.text18_700.copyWith(color: lightBlue, height: 1)),
        ...
        Padding(
          ...
          child: Text(
            '${'are_you_sure_you_want_to_close_the_application'.recast}?',
          ...
          children: [
            ...
            Expanded(
              child: ElevateButton(
                ...
                onTap: () => platform.Platform.isAndroid ? SystemNavigator.pop() : platform.exit(0),
              ),
            ),
