...
Future<void> deleteConversationDialog({Function()? onDelete}) async {
  var context = navigatorKey.currentState!.context;
  // sl<AppAnalytics>().screenView('delete-conversation-popup');
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            'delete_conversation_description'.recast,
            textAlign: TextAlign.center,
