...
class WishlistGridList extends StatelessWidget {
  final double gap;
  final ScrollPhysics physics;
  final List<Wishlist> wishlistItems;
  final Function()? onAdd;
  final Function(Wishlist, int)? onDisc;

  const WishlistGridList({
        ...
        children: [
          ...
          Column(
            children: [
              ...
              Text(
                item.disc?.brand?.name ?? 'n/a'.recast,
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                textAlign: TextAlign.center,
