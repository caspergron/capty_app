...
class PdgaDiscList extends StatelessWidget {
  final double gap;
          ...
          child: Column(
            children: [
              ...
              Text(
                ...
                style: TextStyles.text14_700.copyWith(color: lightBlue, height: 1.1),
              ),
              ...
              Text(
                ...
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: TextStyles.text12_600.copyWith(color: lightBlue, height: 1.2),
              ),
