...
import 'package:app/features/marketplace_management/marketplace/components/club_tag_info_dialog.dart';
import 'package:app/features/marketplace_management/marketplace/components/edit_sales_ad_dialog.dart';
import 'package:app/features/marketplace_management/marketplace/components/marketplace_flter_sheet.dart';
import 'package:app/features/marketplace_management/marketplace/components/sales_ad_dialog.dart';
import 'package:app/features/marketplace_management/marketplace/components/search_input_dialog.dart';
import 'package:app/features/marketplace_management/marketplace/components/sold_info_dialog.dart';
import 'package:app/features/marketplace_management/marketplace/components/tournament_tag_info_dialog.dart';
...
import 'package:app/features/marketplace_management/marketplace/units/sales_ad_grid_list.dart';
...
class _MarketplaceScreenState extends State<MarketplaceScreen> with SingleTickerProviderStateMixin {
  ...
  void _onSalesAdItem(SalesAd item, int index) => salesAdDialog(
        ...
        onEdit: (details) =>
            editSalesAdDiscDialog(marketplace: details, onSave: (p, d) => _viewModel.onUpdateSalesAdDisc(details, index - 1, p, d)),
      );
