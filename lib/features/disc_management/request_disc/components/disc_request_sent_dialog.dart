...
Future<void> discRequestSentDialog() async {
  ...
  await showGeneralDialog(
    context: context,
    barrierLabel: 'Disc Request Sent Dialog',
  ...
  Widget _screenView(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text('${'thank_you'.recast}!', textAlign: TextAlign.center, style: TextStyles.text18_700.copyWith(color: lightBlue, height: 1)),
        ...
        Padding(
          ...
          child: Text(
            '${'we_will_review_the_data_from_this_discs'.recast}?',
