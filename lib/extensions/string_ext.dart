...
extension ParseStrngs3 on String? {
  ...
  String get firstLetterCapital => this == null ? '' : '${this![0].toUpperCase()}${this!.substring(1)}';

  String get allFirstLetterCapital {
    if (this == null) return '';
    return this!.split(' ').map((word) => word.isNotEmpty ? '${word[0].toUpperCase()}${word.substring(1).toLowerCase()}' : '').join(' ');
  }
