...
// final _CENTER = 5.0;
// final _INITIAL_SPOT = FlSpot(_CENTER, 0);
...
class GraphHelper {
  ...
  Map<String, double> getMaxValuesForGrid(List<ScatterSpot> scatterSpots) {
    ...
    final maxX = scatterSpots.reduce((item1, item2) => item1.x > item2.x ? item1 : item2).x;
    final maxY = scatterSpots.reduce((item1, item2) => item1.y > item2.y ? item1 : item2).y;
